...
from immunity_controller.connection.connectors.ssh import Ssh
from immunity_controller.connection.models import DeviceConnection
from immunity_controller.connection.settings import CONNECTORS, UPDATE_STRATEGIES
from immunity_controller.connection.tests.utils import CreateConnectionsMixin, SshServer
from immunity_monitoring.check.classes.iperf3 import get_iperf3_schema
from immunity_monitoring.check.classes.iperf3 import logger as iperf3_logger
...
class TestIperf3(
    ...
    _IPERF3_TEST_SERVER = ['iperf3.immunitytestserver.com']
    _IPERF3_TEST_MULTIPLE_SERVERS = [
        'iperf3.immunitytestserver1.com',
        'iperf3.immunitytestserver2.com',
    ]
    ...
    def setUp(self):
        ...
        self._EXPECTED_COMMAND_CALLS = [
            call(
                (
                    'iperf3 -c iperf3.immunitytestserver.com -p 5201 -t 10 --connect-timeout 1000 '
    ...
    def _set_auth_expected_calls(self, config):
        ...
        server = 'iperf3.immunitytestserver.com'
    ...
    def test_iperf3_check_params(self, mock_warn, mock_exec_command):
        ...
        test_params = {
            'username': 'immunity-test-user',
            'password': 'immunity_pass',
    ...
    def test_iperf3_check_config(self, mock_warn, mock_exec_command):
        ...
        self._EXPECTED_COMMAND_CALLS = [
            call(
                (
                    'iperf3 -c iperf3.immunitytestserver.com -p 9201 -k 1M --connect-timeout 2000 '
        ...
        iperf3_config = {
            self.org_id: {
                'host': ['iperf3.immunitytestserver.com'],
                'client_options': {
                    'port': 9201,
                    'time': 120,
