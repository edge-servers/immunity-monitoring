...
from immunity_monitoring.check.settings import AUTO_CONFIG_CHECK, AUTO_PING
from immunity_monitoring.check.tasks import auto_create_config_check, auto_create_ping
...
def remove_config_applied_checks(apps, schema_editor):
    ...
    Check.objects.filter(
        check='immunity_monitoring.check.classes.ConfigApplied'
    ).delete()
