...
def auto_create_ping(
    ...
    ping_path = 'immunity_monitoring.check.classes.Ping'
...
def auto_create_config_check(
    ...
    """
    Called by immunity_monitoring.check.models.auto_config_check_receiver
    """
    Check = check_model or get_check_model()
    config_check_path = 'immunity_monitoring.check.classes.ConfigApplied'
    has_check = Check.objects.filter(
...
def auto_create_iperf3_check(
    ...
    """
    Called by immunity_monitoring.check.models.auto_iperf3_check_receiver
    """
    Check = check_model or get_check_model()
    iperf3_check_path = 'immunity_monitoring.check.classes.Iperf3'
    has_check = Check.objects.filter(
