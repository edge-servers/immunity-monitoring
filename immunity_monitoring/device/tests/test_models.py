...
from immunity_controller.connection.tasks import update_config
from immunity_controller.connection.tests.base import CreateConnectionsMixin
...
class TestDeviceData(BaseTestCase):
    """
    Test immunity_monitoring.device.models.DeviceData
    """
    ...
    @patch('immunity_monitoring.device.settings.MAC_VENDOR_DETECTION', True)
    ...
    @patch('immunity_controller.connection.tasks.logger.info')
...
class TestDeviceMonitoring(CreateConnectionsMixin, BaseTestCase):
    """
    Test immunity_monitoring.device.models.DeviceMonitoring
    """
    ...
    @patch('immunity_monitoring.device.settings.AUTO_CLEAR_MANAGEMENT_IP', False)
