...
from immunity_controller.config.tests.test_admin import TestImportExportMixin
from immunity_controller.config.tests.utils import CreateDeviceGroupMixin
...
class TestAdmin(
    ...
    """
    Test the additions of immunity-monitoring to DeviceAdmin
    """
