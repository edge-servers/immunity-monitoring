...
from immunity_controller.config.signals import checksum_requested, config_status_changed
from immunity_controller.connection import settings as connection_settings
from immunity_controller.connection.signals import is_working_changed
...
class DeviceMonitoringConfig(AppConfig):
    name = 'immunity_monitoring.device'
